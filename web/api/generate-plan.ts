...
- talking_points: { hook: 훅 아이디어, facts: 사실 3개 배열, case_tip: 사례 활용 팁, closing_idea: 마무리 아이디어, avoid: 피할 것 } (각 필드 짧게, 30자 이내)
...
위 데이터 기반으로 쇼츠 카드 15개 + 롱폼 후보 3~4개를 생성해줘. JSON만 응답.`
